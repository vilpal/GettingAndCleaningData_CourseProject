...
This is a code book that describes the variables, the data, and transformations and work that was performed to clean up the data for this course project.
